...
int main()
{
    ...
    //glBindAttribLocation(ourShader.ID, 1, "in_Color");
    //glBindAttribLocation(ourShader.ID, 2, "model");
    //glBindAttribLocation(ourShader.ID, 3, "view");
    //glBindAttribLocation(ourShader.ID, 4, "projection");
    ourShader.use();
